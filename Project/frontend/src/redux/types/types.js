...
export const GET_ALL_USERS_PROFILES = 'GET_ALL_USERS_PROFILES';
export const GET_PARTICULAR_USER_PROFILE = 'GET_PARTICULAR_USER_PROFILE';

export const GET_ALL_USERS_SPECIAL_FIELDS = 'GET_ALL_USERS_SPECIAL_FIELDS';