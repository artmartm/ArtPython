    ...
    return (
        <div>
            {teams.length > 0 && stadium.team ?
                <div style={{ backgroundImage: `url(${stadium.image})`}}>
                    <div className='main-stadium-div' >
                        <div>
                            <h1>{stadium.name}</h1>
                            <img src={teams[stadium.team-1].team_logo} className='main_img'/>
                            <h2>{stadium.max_capacity}</h2>
                            <h2>{stadium.avg_attendence}</h2>
